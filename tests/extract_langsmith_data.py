...
def extract_langsmith_data(project_name, model_name, dataset_name, api_key):
    ...
    output_runs = client.list_runs(project_name=project_name, is_root=True)
...
def main():
    ...
    extract_langsmith_data(project_name=args.project_name, model_name=args.model_name, dataset_name=args.dataset_name, api_key=api_key)
