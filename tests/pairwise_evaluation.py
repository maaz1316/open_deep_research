...
HEAD_TO_HEAD_PROMPT = """
We are testing out two different implementations of a deep research agent.
This research agent is designed to conduct deep research on a given question.
...
- A good research agent should research sufficient sources to answer the question.
  These sources should be diverse and high quality. More sources is not always necessarily better,
  but it is important to have ENOUGH sources to feel confident in the claims that are made.
- A good research agent should completely and comprehensively answer the user's question.
- Deep research agents are expensive. The user expects a very good, and also very detailed answer.
  They should get all of the information that they need from this response, and should not have to
  ask for followups usually.
- Citations should be provided for all claims, and should be formatted in a way that is easy to read
  and understand.

Important:
These two implementations conducted research differently, and so they might have different information
and different sources. This is a key point for you to evaluate.
Which agent was able to find better sources and better answer the question?
The #1 thing we care about the most is the quality and comprehensiveness of the answer.
...
ALL_THREE_PROMPT = """
We are testing out three different implementations of a deep research agent.
This research agent is designed to conduct deep research on a given question.
...
Important:
These three implementations conducted research differently, and so they might have different
information and different sources. This is a key point for you to evaluate.
Which agent was able to find better sources and better answer the question?
The #1 thing we care about the most is the quality and comprehensiveness of the answer.

With those criteria in mind, please rank the responses from 1 to 3, where 1 is the best response,
2 is the second best response, and 3 is the worst response.
